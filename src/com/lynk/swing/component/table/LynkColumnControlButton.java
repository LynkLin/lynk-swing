 ...
 *   is a key of type String which starts with {@link LynkColumnControlButton.COLUMN_CONTROL_MARKER} 
 ...
 * 
 */
public class LynkColumnControlButton extends JButton {
     ...
     */
    public LynkColumnControlButton(JXTable table) {
        this(table, null);
    }
     ...
     */
    public LynkColumnControlButton(JXTable table, Icon icon) {
        super();
        init();
