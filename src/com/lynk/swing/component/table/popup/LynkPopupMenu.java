 ...
 *
 */
public class LynkPopupMenu extends ResizablePopupMenu implements ActionListener {
	private static final long	serialVersionUID	= 1;
	private JPanel				panelMenus			= new JPanel();
	private JScrollPane			scroll				= null;
	private JFrame				jframe				= null;
	public static final Icon EMPTY_IMAGE_ICON = new ImageIcon(LynkPopupMenu.class.getResource("/resources/images/menu_spacer.gif"));

	public LynkPopupMenu(JFrame jframe) {
		super();
		this.jframe = jframe;
	...
	public void add(AbstractButton menuItem) {
		...
		if (!(menuItem instanceof LynkCheckedButton)) {
			System.out.println(menuItem.getName());
		}
	}

	public void addSeparator() {
		panelMenus.add(new LynkSeperator());
	}
	...
	private static class LynkSeperator extends JSeparator {
		/**
		 * 
		 */
